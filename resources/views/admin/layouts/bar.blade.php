            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{ route('dashboard') }}">
                        <h3 class="brand-text">KK - SCOUT</h3>
                    </a>
                </li>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                <a href="#"><i class="icon-layers"></i>
                    <span class="menu-title">Bidang Penelitian</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{ route('research-fields.index') }}">Daftar</a></li>
                    {{-- <li><a class="menu-item" href="{{ route('partnerships.create') }}">Tambahkan</a></li> --}}
                </ul>
            </li>
            <li class="nav-item">
                <a href="#"><i class="icon-layers"></i>
                    <span class="menu-title"> Bidang Pengabdian</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{ route('products.index') }}">Daftar</a></li>
                    {{-- <li><a class="menu-item" href="{{ route('partnerships.create') }}">Tambahkan</a></li> --}}
                </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a href="#"><i class="icon-layers"></i><span class="menu-title">Anggota</span></a>
                <ul class="menu-content">
